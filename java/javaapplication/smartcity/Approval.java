    ...
    private void fillComboBox()
    {
            ...
            try
            {
                ...
                if(con!=null)
                {
                    ...
                    while(rs2.next())
                    {
                        String name=rs2.getString("school_name");
                        userType.addItem(name);
                    }
//                    System.out.print(user1);
//                    if(user1.equalsIgnoreCase("principal"))
//                    {
//                        String query2="select * from details where infra_type=?";
//                        pst2=con.prepareStatement(query2);
//                        pst2.setString(1,"School");
//                        rs2=pst2.executeQuery();
//                        while(rs2.next())
//                        {
//                            String name=rs2.getString("school_name");
                    ...
                    if(rs.next())
                    {
                        ...
                        if(type.equalsIgnoreCase("school"))
                        {
                            ...
                            if(rs1.next())
                            {
                                ...
                                {
                                    {
                                        if(app.equalsIgnoreCase("pending"))
                                        {
                                ...
                                {
                                    {
                                        if(app1.equalsIgnoreCase("pending"))
                                        {
                                            Approval.setVisible(true);
                                            deleteButton.setText("Update");
                                        }
