 ...
 * @author vivek
 */
public class Principal_Approval extends javax.swing.JFrame {

    /**
     * Creates new form Layout
     */
    public Principal_Approval() {
        initComponents();
...
//    public void fillPanel(String sName, String sCode, String sArea, String sAddress, String sDistrict, String sState, String sPrinApproval)
//    {
//        deletetxt1.setText(sName);
//        deletetxt3.setText(sCode);
//        deletetxt4.setText(sArea);
//        deletetxt7.setText(sAddress);
//        deletetxt9.setText(sDistrict);
//        deletetxt11.setText(sState);
//        deletetxt13.setText(sPrinApproval);
//        deletetxt1.setVisible(true);
//        deletetxt3.setVisible(true);
//        deletetxt4.setVisible(true);
//        deletetxt7.setVisible(true);
        ...
        try{
            ...
            if(conn!=null)
            {
                ...
                if(rs.next())
                {
                    ...
                    deletetxt3.setVisible(true);
                    deletetxt2.setVisible(true);
                    deletetxt4.setText(rs.getString("area"));
                    deletetxt4.setVisible(true);
                    deletetxt5.setVisible(true);
                    ...
                    deletetxt10.setVisible(true);
                    deletetxt12.setVisible(true);
                    String PApproval=rs.getString("principal_approval");
                    String MApproval=rs.getString("mla_approval");
                    if(PApproval.equalsIgnoreCase("pending"))
                    {
                        Approval.setVisible(true);
                        deleteButton.setVisible(true);
                    }
                    else if(PApproval.equalsIgnoreCase("approved") && MApproval.equalsIgnoreCase("approved"))
                    {
                        deletetxt13.setText("Approved");
                        deletetxt13.setVisible(true);
                    }
                    else if(PApproval.equalsIgnoreCase("approved") && MApproval.equalsIgnoreCase("pending"))
                    {
...
//        String type=deletetxt1.getText();
        ...
        Connection con=null;
            ...
            try
            {
                ...
                if(con!=null)
                {
                    String query="update school set principal_approval=? where school_name=?";
                    pst=con.prepareStatement(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Principal_Approval.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Principal_Approval().setVisible(true);
            }
        });
    }
